...
```{=html}
<div class="schedule-actions" style="margin: 1.5rem 0 0.5rem;">
  <a href="webinar-jun2026/twa-research-deck1-foundations-voice.pdf" class="slides-btn" style="font-size: 0.95rem; padding: 0.6rem 1.5rem;">
    Deck 1: Foundations &amp; Voice (PDF) →
  </a>
  <a href="webinar-jun2026/twa-research-deck2-website-brainstorming.pdf" class="slides-btn" style="font-size: 0.95rem; padding: 0.6rem 1.5rem;">
    Deck 2: Website &amp; Brainstorming (PDF) →
  </a>
</div>
```
