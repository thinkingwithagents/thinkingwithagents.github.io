...
\begin{frame}{The Code It Wrote}
\centering
\vskip2pt
\includegraphics[width=0.85\textwidth, height=0.75\textheight, keepaspectratio]{lee_bounds_code.png}
\vskip4pt
{\scriptsize\color{CoolGray} Installs \texttt{leebounds} if needed, loads data, restricts to App arm vs.\ control, builds the outcome, runs the bounds.
\href{file:///Users/ebeam/Dropbox/GitHub/bd-remote-ed/code/07_Dofiles_academic/lee_bounds_app.do}{\color{AccentBlue}\;\underline{Open do-file}}}
\end{frame}

%% ====== SLIDE: LEE BOUNDS RESULTS ======
\begin{frame}{The Results}
\centering
\vskip2pt
\includegraphics[width=0.92\textwidth, height=0.62\textheight, keepaspectratio]{lee_bounds_results.png}
\vskip4pt
\begin{tcolorbox}[accentbox, width=12cm, top=3pt, bottom=3pt]
\small Bounds span zero for all three outcomes. Differential attrition ($-9.6$pp) is large enough to make Lee bounds uninformative about the direction. \textbf{From referee comment to answer: $\sim$10 minutes.}
\end{tcolorbox}
\vskip3pt
