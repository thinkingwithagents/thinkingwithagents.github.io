...
:::: {.columns}
::: {.column width="58%"}
![](assets/preferences-placeholder.svg){width="100%" .shot}
:::
::: {.column width="42%"}
...
:::: {.columns}
::: {.column width="58%"}
![](assets/compacting-placeholder.svg){width="100%" .shot}
:::
::: {.column width="42%"}
- compacting summarizes the useful state, then lets you continue with a cleaner session
- it is most helpful for larger tasks, not every tiny edit
- Codex is currently better at doing this automatically
- Claude is improving, but it is still useful to think about this explicitly
:::
::::
