...
**This page is part of [Getting Started](getting-started.qmd) → Layer 3.** It has the step-by-step install instructions for Claude Code and Codex on Mac and Windows.
:::
