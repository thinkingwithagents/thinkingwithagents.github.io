...
**Starting from scratch?** See [Getting Started](getting-started.qmd) for the full path from zero to setup-ready. This page covers installation once you're ready for it.
:::
