...
**Installation**: Our [Prep Guide](prep.qmd) has step-by-step instructions for both tools on Mac and Windows. Start there.
...
Once you're comfortable with the basics, the [Prep Guide](prep.qmd) covers installation details and troubleshooting. [Applications & Skills](applications.qmd) shows specific research and teaching workflows. And the [Bells & Whistles](resources.qmd) page covers integrations and advanced tools for when you're ready to go deeper.

If you're attending one of our [webinars](index.qmd#upcoming-webinars--june-2026) — this page is your pre-work. You don't need all five layers before the session, but Layers 1-3 will help you follow along.
