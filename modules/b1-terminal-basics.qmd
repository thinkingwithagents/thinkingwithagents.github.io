...
## Click to expand: Other useful ls flags
...
::: {.callout-tip collapse="true"}
## Click to expand: cd shortcuts reference
...
::: {.callout-tip collapse="true"}
## Click to expand: A note on spaces in filenames
...
The two flags you'll use most: `-r` (search all files in a directory) and `-n` (show line numbers).

::: {.callout-tip collapse="true"}
## Click to expand: All grep flags worth knowing
...
::: {.callout-tip collapse="true"}
## Click to expand: File Operations (mkdir, cp, mv, rm)
...
::: {.callout-tip collapse="true"}
## Click to expand: A few more useful commands
...
::: {.callout-tip collapse="true"}
## Click to expand: Sample solution (for the practice data)
