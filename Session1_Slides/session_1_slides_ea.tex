...
\end{tcolorbox}
\vskip6pt
\includegraphics[width=0.72\textwidth, keepaspectratio]{figures/website-ea.png}
\vskip6pt
{\small\color{CoolGray} Dark hero, full-width layout, prominent name --- generated in a single session.}
\end{frame}
