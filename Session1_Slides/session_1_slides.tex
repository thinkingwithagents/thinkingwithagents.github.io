...
\only<2>{%
\includegraphics[width=\textwidth, height=0.7\textheight, keepaspectratio]{multi-workflow-1.png}
}%
\end{column}
...
\vskip4pt
You do \textbf{not} need to learn the syntax. The AI hands you a \texttt{.md} file; a viewer like \textbf{Typora} (\$15) makes it look like formatted text.
\end{tcolorbox}
\end{column}
...
\scriptsize
\begin{itemize}\setlength{\itemsep}{1pt}
  \item \textbf{Confident citations that don't exist.} It will invent a plausible author, journal, and year.
  ...
  \item \textbf{Hallucinated numbers.} Asks for a statistic, gets a plausible-sounding one that is made up.
\end{itemize}
\end{tcolorbox}
\end{column}
\begin{column}{0.47\textwidth}
...
\scriptsize
\begin{itemize}\setlength{\itemsep}{1pt}
  \item \textbf{Verify citations.} Google Scholar or CrossRef every reference.
  ...
  \item \textbf{Use version control.} Git means you can always undo.
\end{itemize}
\end{tcolorbox}
\end{column}
\end{columns}
...
\begin{itemize}\setlength{\itemsep}{2pt}
  ...
  \item Anything with \textbf{confidential data} you can't share with an API
...
\begin{axis}[
    ...
    xtick={1,2,3,4},
    xticklabels={{\scriptsize\textbf{Erkmen}}, {\scriptsize\textbf{Emily}}, {\scriptsize\textbf{\color{SlateTeal}\$100 experiment}}, {\scriptsize\textbf{\color{SlateTeal}\$20 experiment}}},
...
\small \textbf{\$20/mo} is a really good experiment. \textbf{\$100/mo} is an amazing one. You do \textbf{not} need to go all-in.\\[2pt]
{\scriptsize Keeping up with the frontier is a full-time job. Let us do that --- you get to skip straight to the useful parts.}
\end{tcolorbox}
\vskip1pt
{\tiny\color{CoolGray} Also cut: Cursor (\$20/mo) --- was underutilizing. Considering: Claude Max (\$200/mo) for heavier workloads.}
\end{frame}
